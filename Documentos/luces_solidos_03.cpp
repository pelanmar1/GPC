...
void luces()
{
	...
	const GLfloat light_specular0[4] = { 1.0f, 1.0f, 1.0f, 1.0f };  // charolazos blancos
	...
	const GLfloat light_specular1[4] = { 1.0f, 1.0f, 1.0f, 1.0f }; // charolazo blanco
	const GLfloat light_ambient1[4] = { 1.0f, 0.0f, 0.0f, 1.0f };  // ambiente rojo

	const GLfloat light_position2[4] = { 0.5f, 0.0f, d, 1.0f }; 
	const GLfloat light_diffuse2[4] = { 0.0f, 1.0f, 0.0f, 1.0f };  // verde
	const GLfloat light_specular2[4] = { 1.0f, 1.0f, 1.0f, 1.0f }; // charolazo blanco
	const GLfloat light_ambient2[4] = { 0.0f, 1.0f, 0.0f, 1.0f };  // ambiente verde
