...
void luces()
{
	...
	const GLfloat light_position2[4] = { 0.5f, 0.0f, 0.0f, 1.0f };
	const GLfloat light_diffuse2[4] = { 0.0f, 1.0f, 0.0f, 1.0f };
	const GLfloat light_specular2[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	const GLfloat light_ambient2[4] = { 0.0f, 1.0f, 0.0f, 1.0f };
