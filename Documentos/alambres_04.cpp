...
void inyectaOtroPoliedro()
{
	...
	int k;
	float coordenadas[21] = { 0.5f,  0.0f,  0.5f, //Vértice superior de la pirámide
	...
	vec3 origen_base;
	origen_base[0] = coordenadas[18];
	origen_base[1] = coordenadas[19];
	origen_base[2] = coordenadas[20];
...
int main(void)
{
	...
	const GLfloat light_position[4] = { -0.1f, 0.0f, 0.5f, 1.0f };
	const GLfloat light_diffuse[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	const GLfloat light_specular[4] = { 1.0f, 0.5f, 0.5f, 1.0f };
